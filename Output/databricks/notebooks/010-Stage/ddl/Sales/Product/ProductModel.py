...
# MAGIC %md
# MAGIC # DDL for bronze.Sales_Product_ProductModel
...
create_sql = f"""CREATE TABLE IF NOT EXISTS {catalog_name}.{zone}.Sales_Product_ProductModel (
...
USING DELTA
COMMENT 'Product model information entity'
CLUSTER BY (`ProductModelID`)
