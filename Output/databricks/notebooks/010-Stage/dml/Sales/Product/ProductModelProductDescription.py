...
max_source["raw_Sales_Product_ProductModelProductDescription"] = spark.sql(f"""
SELECT
...
source_delta_1_df = (
    ...
    .filter(F.col("__InsertTimestampUTC") > F.lit(max_source["raw_Sales_Product_ProductModelProductDescription"]))
    .selectExpr(
