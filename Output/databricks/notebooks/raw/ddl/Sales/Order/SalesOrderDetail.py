...
schema = StructType([
    ...
    StructField("UnitPrice", DataType.fromDDL("DECIMAL"), False),
    StructField("UnitPriceDiscount", DataType.fromDDL("DECIMAL"), False),
    StructField("LineTotal", DataType.fromDDL("DECIMAL"), False),
