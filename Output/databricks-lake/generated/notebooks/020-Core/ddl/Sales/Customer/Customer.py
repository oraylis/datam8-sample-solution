...
# MAGIC %md
# MAGIC # DDL for silver.Sales_Customer_Customer
...
schema = StructType([
    ...
    StructField("KundenNummer", DataType.fromDDL("INT"), False, metadata={'comment': 'Unique key for the customer', 'business_key': True}),
    StructField("Vorname", DataType.fromDDL("STRING"), False),
    StructField("Nachname", DataType.fromDDL("STRING"), False),
    StructField("AddressType", DataType.fromDDL("STRING"), True),
])
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'write_mode': 'overwrite', 'jobs': 'weekly', 'data_retention': '7_days'})
