...
schema = StructType([
    ...
    StructField("RevisionNumber", DataType.fromDDL("SMALLINT"), False),
    ...
    StructField("Status", DataType.fromDDL("SMALLINT"), False),
    ...
    StructField("CustomerID", DataType.fromDDL("INT"), True),
