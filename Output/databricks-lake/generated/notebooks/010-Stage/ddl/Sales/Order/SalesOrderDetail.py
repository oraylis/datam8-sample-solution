...
schema = StructType([
    ...
    StructField("SalesOrderID", DataType.fromDDL("INT"), True, metadata={'business_key': True}),
    StructField("SalesOrderDetailID", DataType.fromDDL("INT"), True, metadata={'business_key': True}),
    StructField("OrderQty", DataType.fromDDL("SMALLINT"), False),
    StructField("ProductID", DataType.fromDDL("INT"), True),
