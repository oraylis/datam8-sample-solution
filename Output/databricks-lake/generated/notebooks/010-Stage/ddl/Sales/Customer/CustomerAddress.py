...
# MAGIC %md
# MAGIC # DDL for stage.Sales_Customer_CustomerAddress
...
table_comment = "Customer address relationship entity"
...
schema = StructType([
    ...
    StructField("CustomerID", DataType.fromDDL("INT"), True, metadata={'business_key': True}),
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'jobs': 'sales_daily', 'enable_type_widening': 'true', 'column_mapping_mode': 'name', 'write_mode': 'overwrite', 'data_retention': '7_days'})

# column attributes
table_instance.set_column_tags("CustomerID", {'data_layout': 'hive_partitioning'})
table_instance.set_column_tags("AddressID", {'data_layout': 'liquid_clustering'})