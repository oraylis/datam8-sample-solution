...
# MAGIC %md
# MAGIC # DDL for stage.Sales_Customer_DIMTIME
...
schema = StructType([
    ...
    StructField("DAYNUMBEROFMONTH", DataType.fromDDL("DECIMAL(38,10)"), True),
    StructField("DAYNUMBEROFYEAR", DataType.fromDDL("DECIMAL(38,10)"), True),
    StructField("WEEKNUMBEROFYEAR", DataType.fromDDL("DECIMAL(38,10)"), True),
    ...
    StructField("MONTHNUMBEROFYEAR", DataType.fromDDL("DECIMAL(38,10)"), True),
    StructField("CALENDARQUARTER", DataType.fromDDL("DECIMAL(38,10)"), True),
    StructField("CALENDARYEAR", DataType.fromDDL("STRING"), True),
    StructField("CALENDARSEMESTER", DataType.fromDDL("DECIMAL(38,10)"), True),
    StructField("FISCALQUARTER", DataType.fromDDL("DECIMAL(38,10)"), True),
    StructField("FISCALYEAR", DataType.fromDDL("STRING"), True),
    StructField("FISCALSEMESTER", DataType.fromDDL("DECIMAL(38,10)"), True),
])
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'jobs': 'sales_daily', 'enable_type_widening': 'true', 'column_mapping_mode': 'name', 'write_mode': 'merge', 'data_retention': '7_days'})
