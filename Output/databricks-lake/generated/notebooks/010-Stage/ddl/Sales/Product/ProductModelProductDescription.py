...
# MAGIC %md
# MAGIC # DDL for stage.Sales_Product_ProductModelProductDescription
...
table_comment = "Product model to description relationship entity"
...
schema = StructType([
    ...
    StructField("ProductModelID", DataType.fromDDL("INT"), True, metadata={'business_key': True}),
    StructField("ProductDescriptionID", DataType.fromDDL("INT"), True, metadata={'business_key': True}),
