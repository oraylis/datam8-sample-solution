...
# MAGIC %md
# MAGIC # DML for raw.Sales_Product_ProductCategory
...
source_location = "[SalesLT].[ProductCategory]"
data_source_type = "SQLServer"
column_renames = []
delta_column_details = [{"canonicalDataType": "datetime", "sourceName": "ModifiedDate"}]
target_columns = ["ProductCategoryID", "ParentProductCategoryID", "Name", "rowguid", "ModifiedDate"]
