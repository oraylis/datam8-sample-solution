...
# MAGIC %md
# MAGIC # DML for raw.Sales_Product_ProductDescription
...
source_location = "[SalesLT].[ProductDescription]"
data_source_type = "SQLServer"
column_renames = []
delta_column_details = [{"canonicalDataType": "datetime", "sourceName": "ModifiedDate"}]
target_columns = ["ProductDescriptionID", "Description", "rowguid", "ModifiedDate"]
