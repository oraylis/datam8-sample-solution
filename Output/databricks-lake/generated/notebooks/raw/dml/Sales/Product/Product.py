...
# MAGIC %md
# MAGIC # DML for raw.Sales_Product_Product
...
from datam8_sqlserver import extract_data
...
source_location = "[SalesLT].[Product]"
data_source_type = "SQLServer"
column_renames = []
delta_column_details = [{"canonicalDataType": "datetime", "sourceName": "ModifiedDate"}]
target_columns = ["ProductID", "Name", "ProductNumber", "Color", "StandardCost", "ListPrice", "Size", "Weight", "ProductCategoryID", "ProductModelID", "SellStartDate", "SellEndDate", "DiscontinuedDate", "ThumbNailPhoto", "ThumbnailPhotoFileName", "rowguid", "ModifiedDate"]
...
if delta_column_names:
    ...
    where_clause = f"\n    WHERE {source_delta_column} > '{max_external}'"
