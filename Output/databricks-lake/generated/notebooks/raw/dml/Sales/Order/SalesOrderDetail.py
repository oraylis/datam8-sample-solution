...
# MAGIC %md
# MAGIC # DML for raw.Sales_Order_SalesOrderDetail
...
source_location = "[SalesLT].[SalesOrderDetail]"
data_source_type = "SQLServer"
column_renames = []
delta_column_details = [{"canonicalDataType": "datetime", "sourceName": "ModifiedDate"}]
target_columns = ["SalesOrderID", "SalesOrderDetailID", "OrderQty", "ProductID", "UnitPrice", "UnitPriceDiscount", "LineTotal", "rowguid", "ModifiedDate"]
