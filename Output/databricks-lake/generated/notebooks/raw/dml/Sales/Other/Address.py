...
# MAGIC %md
# MAGIC # DML for raw.Sales_Other_Address
...
target_columns = ["AddressID", "AddressLine1", "AddressLine2", "City", "StateProvince", "CountryRegion", "PostalCode", "rowguid", "ModifiedDate"]
