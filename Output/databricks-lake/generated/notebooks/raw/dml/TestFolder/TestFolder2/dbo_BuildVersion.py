...
# MAGIC %md
# MAGIC # DML for raw.TestFolder_TestFolder2_dbo_BuildVersion
...
source_location = "[dbo].[BuildVersion]"
extract_mode = ("").lower()
data_source_type = "SqlDataSource"
column_renames = []
delta_column_details = []
target_columns = ["SystemInformationID", "Database Version", "VersionDate", "ModifiedDate"]
