...
# MAGIC %md
# MAGIC # DDL for raw.Sales_Customer_dimtime
...
table_comment = "Time dimension entity for calendar and fiscal dates"
...
schema = StructType([
    ...
    StructField("TIMEKEY", DataType.fromDDL("BIGINT"), False),
    StructField("FULLDATEALTERNATEKEY", DataType.fromDDL("TIMESTAMP"), True),
    StructField("DAYNUMBEROFWEEK", DataType.fromDDL("BIGINT"), True),
    StructField("ENGLISHDAYNAMEOFWEEK", DataType.fromDDL("STRING"), True),
    StructField("SPANISHDAYNAMEOFWEEK", DataType.fromDDL("STRING"), True),
    StructField("FRENCHDAYNAMEOFWEEK", DataType.fromDDL("STRING"), True),
    StructField("DAYNUMBEROFMONTH", DataType.fromDDL("BIGINT"), True),
    StructField("DAYNUMBEROFYEAR", DataType.fromDDL("BIGINT"), True),
    StructField("WEEKNUMBEROFYEAR", DataType.fromDDL("BIGINT"), True),
    StructField("ENGLISHMONTHNAME", DataType.fromDDL("STRING"), True),
    StructField("SPANISHMONTHNAME", DataType.fromDDL("STRING"), True),
    StructField("FRENCHMONTHNAME", DataType.fromDDL("STRING"), True),
    StructField("MONTHNUMBEROFYEAR", DataType.fromDDL("BIGINT"), True),
    StructField("CALENDARQUARTER", DataType.fromDDL("BIGINT"), True),
    StructField("CALENDARYEAR", DataType.fromDDL("STRING"), True),
    StructField("CALENDARSEMESTER", DataType.fromDDL("BIGINT"), True),
    StructField("FISCALQUARTER", DataType.fromDDL("BIGINT"), True),
    StructField("FISCALYEAR", DataType.fromDDL("STRING"), True),
    StructField("FISCALSEMESTER", DataType.fromDDL("BIGINT"), True),
])
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'jobs': 'sales_daily', 'enable_type_widening': 'true', 'column_mapping_mode': 'name', 'extract_mode': 'full'})
