...
# MAGIC %md
# MAGIC # DDL for raw.Sales_Customer_Customer_DE
...
source_name = "Customer_DE"
full_table_name = "Sales_Customer_Customer_DE"
...
schema = StructType([
    ...
    StructField("KundenID", DataType.fromDDL("INT"), True),
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'jobs': 'sales_daily', 'enable_type_widening': 'true', 'column_mapping_mode': 'name'})
