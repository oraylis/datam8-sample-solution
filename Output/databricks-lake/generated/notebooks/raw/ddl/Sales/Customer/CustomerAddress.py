...
# MAGIC %md
# MAGIC # DDL for raw.Sales_Customer_CustomerAddress
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'jobs': 'daily', 'table_properties': ['type_widening', 'column_mapping'], 'extract_mode': 'query'})
