...
# MAGIC %md
# MAGIC # DDL for raw.Sales_Product_ProductModelProductDescription
...
schema = StructType([
    ...
    StructField("ProductModelID", DataType.fromDDL("INT"), False),
    StructField("ProductDescriptionID", DataType.fromDDL("INT"), False),
    StructField("Culture", DataType.fromDDL("STRING"), False),
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'jobs': 'daily', 'table_properties': ['type_widening', 'column_mapping'], 'extract_mode': 'delta'})
