...
# MAGIC %md
# MAGIC # DDL for raw.Sales_Order_SalesOrderDetail
...
schema = StructType([
    ...
    StructField("SalesOrderDetailID", DataType.fromDDL("INT"), False),
    StructField("OrderQty", DataType.fromDDL("INT"), False),
