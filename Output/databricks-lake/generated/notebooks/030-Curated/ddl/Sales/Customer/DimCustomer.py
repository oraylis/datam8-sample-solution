...
schema = StructType([
    ...
    StructField("CustomerSID", DataType.fromDDL("BIGINT"), False, metadata={'comment': 'Customer surrogate key', 'surrogate_key': True}),
...
# table attributes
table_instance.set_table_tags({'business_area': 'sales', 'write_mode': 'merge', 'jobs': 'weekly', 'data_retention': '7_days'})
