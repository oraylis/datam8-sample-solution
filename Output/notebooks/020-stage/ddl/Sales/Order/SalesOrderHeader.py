...
schema = StructType([
    StructField("SalesOrderID", StructType.fromDDL("int"), False),
    StructField("RevisionNumber", StructType.fromDDL("tinyint"), False),
    StructField("OrderDate", StructType.fromDDL("timestamp"), False),
    StructField("DueDate", StructType.fromDDL("timestamp"), False),
    StructField("ShipDate", StructType.fromDDL("timestamp"), True),
    StructField("Status", StructType.fromDDL("tinyint"), False),
    StructField("OnlineOrderFlag", StructType.fromDDL("boolean"), False),
    StructField("SalesOrderNumber", StructType.fromDDL("string"), False),
    StructField("PurchaseOrderNumber", StructType.fromDDL("string"), True),
    StructField("AccountNumber", StructType.fromDDL("string"), True),
    StructField("CustomerID", StructType.fromDDL("int"), False),
    StructField("ShipToAddressID", StructType.fromDDL("int"), True),
    StructField("BillToAddressID", StructType.fromDDL("int"), True),
    StructField("ShipMethod", StructType.fromDDL("string"), False),
    StructField("CreditCardApprovalCode", StructType.fromDDL("string"), True),
    StructField("SubTotal", StructType.fromDDL("decimal(19,4)"), False),
    StructField("TaxAmt", StructType.fromDDL("decimal(19,4)"), False),
    StructField("Freight", StructType.fromDDL("decimal(19,4)"), False),
    StructField("TotalDue", StructType.fromDDL("decimal(19,4)"), False),
    StructField("Comment", StructType.fromDDL("string"), True),
