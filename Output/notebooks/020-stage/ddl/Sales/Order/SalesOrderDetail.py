...
# MAGIC %md
# MAGIC # DDL for stage.Sales_Order_SalesOrderDetail
...
schema = StructType([
    ...
    StructField("SalesOrderDetailID", StructType.fromDDL("int"), False),
    StructField("OrderQty", StructType.fromDDL("smallint"), False),
    StructField("ProductID", StructType.fromDDL("int"), False),
    StructField("UnitPrice", StructType.fromDDL("decimal(19,4)"), False),
    StructField("UnitPriceDiscount", StructType.fromDDL(
        "decimal(19,4)"), False),
    StructField("LineTotal", StructType.fromDDL("decimal(38,6)"), False),
