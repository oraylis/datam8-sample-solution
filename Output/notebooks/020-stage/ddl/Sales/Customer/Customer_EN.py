...
# MAGIC %md
# MAGIC # DDL for stage.Sales_Customer_Customer_EN
...
schema = StructType([
    ...
    StructField("NameStyle", StructType.fromDDL("boolean"), False),
    StructField("Title", StructType.fromDDL("string"), True),
    StructField("FirstName", StructType.fromDDL("string"), False),
    StructField("MiddleName", StructType.fromDDL("string"), True),
    StructField("LastName", StructType.fromDDL("string"), False),
    StructField("Suffix", StructType.fromDDL("string"), True),
    StructField("CompanyName", StructType.fromDDL("string"), True),
    StructField("SalesPerson", StructType.fromDDL("string"), True),
    StructField("EmailAddress", StructType.fromDDL("string"), True),
    StructField("Phone", StructType.fromDDL("string"), True),
