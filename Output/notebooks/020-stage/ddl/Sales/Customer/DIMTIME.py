...
schema = StructType([
    StructField("TIMEKEY", StructType.fromDDL("int"), False),
    StructField("FULLDATEALTERNATEKEY", StructType.fromDDL("timestamp"), True),
    StructField("DAYNUMBEROFWEEK", StructType.fromDDL("int"), True),
    StructField("ENGLISHDAYNAMEOFWEEK", StructType.fromDDL("string"), True),
    StructField("SPANISHDAYNAMEOFWEEK", StructType.fromDDL("string"), True),
    StructField("FRENCHDAYNAMEOFWEEK", StructType.fromDDL("string"), True),
    StructField("DAYNUMBEROFMONTH", StructType.fromDDL("int"), True),
    StructField("DAYNUMBEROFYEAR", StructType.fromDDL("int"), True),
    StructField("WEEKNUMBEROFYEAR", StructType.fromDDL("int"), True),
    StructField("ENGLISHMONTHNAME", StructType.fromDDL("string"), True),
    StructField("SPANISHMONTHNAME", StructType.fromDDL("string"), True),
    StructField("FRENCHMONTHNAME", StructType.fromDDL("string"), True),
    StructField("MONTHNUMBEROFYEAR", StructType.fromDDL("int"), True),
    StructField("CALENDARQUARTER", StructType.fromDDL("int"), True),
    StructField("CALENDARYEAR", StructType.fromDDL("string"), True),
    StructField("CALENDARSEMESTER", StructType.fromDDL("int"), True),
    StructField("FISCALQUARTER", StructType.fromDDL("int"), True),
    StructField("FISCALYEAR", StructType.fromDDL("string"), True),
    StructField("FISCALSEMESTER", StructType.fromDDL("int"), True),
