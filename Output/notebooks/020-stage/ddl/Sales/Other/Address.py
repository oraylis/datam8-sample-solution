...
# MAGIC %md
# MAGIC # DDL for stage.Sales_Other_Address
...
schema = StructType([
    ...
    StructField("City", StructType.fromDDL("string"), False),
    StructField("StateProvince", StructType.fromDDL("string"), False),
    StructField("CountryRegion", StructType.fromDDL("string"), False),
