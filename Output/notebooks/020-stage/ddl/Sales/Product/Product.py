...
# MAGIC %md
# MAGIC # DDL for stage.Sales_Product_Product
...
schema = StructType([
    StructField("ProductID", StructType.fromDDL("int"), False),
    StructField("Name", StructType.fromDDL("string"), False),
    StructField("ProductNumber", StructType.fromDDL("string"), False),
    StructField("Color", StructType.fromDDL("string"), True),
    StructField("StandardCost", StructType.fromDDL("decimal(19,4)"), False),
    StructField("ListPrice", StructType.fromDDL("decimal(19,4)"), False),
    StructField("Size", StructType.fromDDL("string"), True),
    StructField("Weight", StructType.fromDDL("decimal(8,2)"), True),
    StructField("ProductCategoryID", StructType.fromDDL("int"), True),
    StructField("ProductModelID", StructType.fromDDL("int"), True),
    StructField("SellStartDate", StructType.fromDDL("timestamp"), False),
    StructField("SellEndDate", StructType.fromDDL("timestamp"), True),
    StructField("DiscontinuedDate", StructType.fromDDL("timestamp"), True),
    StructField("ThumbNailPhoto", StructType.fromDDL("binary"), True),
    StructField("ThumbnailPhotoFileName", StructType.fromDDL("string"), True),
