...
schema = StructType([
    StructField("_CustomerAddressBK", StructType.fromDDL("string"), False),
    StructField("_CustomerAddressSID", StructType.fromDDL("bigint"), False),
...
(
    -- Table columns
    `_CustomerAddressBK`           string      NOT NULL  COMMENT 'BK'
,   `_CustomerAddressSID`          bigint      NOT NULL  COMMENT 'SK' GENERATED BY DEFAULT AS IDENTITY
