...
| Entity ID | 1006 |
| Kind | Entity |
| Path | `010-Stage/Sales/Product/ProductModel` |

Generated 2026-04-14T10:38:04.235275+00:00 from schema 2.0.0.

## Description

Product model information entity
...
| 3 | `CatalogDescription` | string (ID) | yes | no | no | HistoryType.SCD1 | N/A | N/A |
...
<details>
  ...
  <p><strong>Reference:</strong> AdventureWorks | <strong>Zone:</strong> Raw Data Layer | <strong>Alias:</strong> ProductModel</p>
  <p><strong>Product/Module:</strong> - / - | <strong>Location:</strong> [SalesLT].[ProductModel]</p>
  ...
  <table>
    ...
    <tr><td><code>CatalogDescription</code></td><td><code>CatalogDescription</code></td><td>xml(200)</td><td>True</td></tr>
