...
| Entity ID | 1004 |
| Kind | Entity |
| Path | `010-Stage/Sales/Product/ProductCategory` |

Generated 2026-04-14T10:38:04.235275+00:00 from schema 2.0.0.

## Description

Product category hierarchy entity
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `ProductCategoryID` | int (ID) | no | yes | no | HistoryType.SCD1 | N/A | N/A |
| 2 | `ParentProductCategoryID` | int (ID) | yes | no | no | HistoryType.SCD1 | N/A | N/A |
| 3 | `Name` | string (ID) | no | no | no | HistoryType.SCD1 | N/A | N/A |
...
<details>
  ...
  <p><strong>Reference:</strong> AdventureWorks | <strong>Zone:</strong> Raw Data Layer | <strong>Alias:</strong> ProductCategory</p>
  <p><strong>Product/Module:</strong> - / - | <strong>Location:</strong> [SalesLT].[ProductCategory]</p>
  ...
  <table>
    ...
    <tbody>
    <tr><td><code>ProductCategoryID</code></td><td><code>ProductCategoryID</code></td><td>int</td><td>False</td></tr>
    <tr><td><code>ParentProductCategoryID</code></td><td><code>ParentProductCategoryID</code></td><td>int</td><td>True</td></tr>
