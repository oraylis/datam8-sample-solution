...
| Entity ID | 1005 |
| Kind | Entity |
| Path | `010-Stage/Sales/Product/ProductDescription` |

Generated 2026-04-14T10:38:04.235275+00:00 from schema 2.0.0.

## Description

Product description text entity
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | `ProductDescriptionID` | int (ID) | no | yes | no | HistoryType.SCD1 | N/A | N/A |
| 2 | `Description` | string (ID) | no | no | no | HistoryType.SCD1 | N/A | N/A |
| 3 | `rowguid` | uniqueidentifier (ID) | no | no | no | HistoryType.SCD1 | N/A | N/A |
| 4 | `ModifiedDate` | datetime (ID) | no | no | no | HistoryType.SCD1 | N/A | N/A |
...
<details>
  ...
  <p><strong>Reference:</strong> AdventureWorks | <strong>Zone:</strong> Raw Data Layer | <strong>Alias:</strong> ProductDescription</p>
  <p><strong>Product/Module:</strong> - / - | <strong>Location:</strong> [SalesLT].[ProductDescription]</p>
  ...
  <table>
    ...
    <tr><td><code>Description</code></td><td><code>Description</code></td><td>nvarchar(400)</td><td>False</td></tr>
