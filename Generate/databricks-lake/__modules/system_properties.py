...
class SystemProperties:
    ...
    # NOTE: This file will be replaced by system_properties.py.jinja2 template
    # which uses Zones.json configuration. This version kept for backward compatibility.
    etl_folder = "/etl"
